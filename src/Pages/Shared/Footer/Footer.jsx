...
const Footer = () => {
    return (
        <div>
        <footer className="footer p-10 bg-base-200 text-base-content mt-20 rounded-t-xl " data-aos="fade-down"
...
<footer className="footer items-center p-4 bg-base-200 text-base-content rounded-b-xl">
